...
import 'package:image_filter_cropper_sketch/custom_libraries/image_filter/filters/color_filters.dart';
import 'package:image_filter_cropper_sketch/custom_libraries/image_filter/filters/image_filters.dart';
import 'package:image_filter_cropper_sketch/custom_libraries/image_filter/models.dart';
import 'package:image_filter_cropper_sketch/custom_libraries/image_filter/utils/image_filter_utils.dart'
    as image_filter_utils;
import 'package:image_filter_cropper_sketch/custom_libraries/image_filter/utils/color_filter_utils.dart'
...
class ContrastSubFilter extends ColorSubFilter with ImageSubFilter {
  ...
  @override
  void apply(Uint8List pixels) => image_filter_utils.contrast(pixels, contrast);
...
class SepiaSubFilter extends ColorSubFilter with ImageSubFilter {
  ...
  @override
  void apply(Uint8List pixels) => image_filter_utils.sepia(pixels, sepia);
...
class GrayScaleSubFilter extends ColorSubFilter with ImageSubFilter {
  ...
  @override
  void apply(Uint8List pixels) => image_filter_utils.grayscale(pixels);
...
class InvertSubFilter extends ColorSubFilter with ImageSubFilter {
  ...
  @override
  void apply(Uint8List pixels) => image_filter_utils.invert(pixels);
